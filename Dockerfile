...
RUN mkdir -p /opt/scitokens-java/bin
RUN mkdir -p /opt/scitokens-java/etc
RUN mkdir -p /opt/scitokens-java/lib
RUN mkdir -p /opt/scitokens-java/log
RUN mkdir -p /opt/scitokens-java/var/qdl/scitokens
RUN mkdir -p /opt/scitokens-java/var/storage/file_store
