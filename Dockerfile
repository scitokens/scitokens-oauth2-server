...
RUN \
    ...
    curl -s -L https://repo1.maven.org/maven2/com/sun/mail/jakarta.mail/1.6.7/jakarta.mail-1.6.7.jar > /opt/tomcat/lib/javax.mail.jar ;\
    curl -s -L https://github.com/ncsa/oa4mp/releases/download/mutable/jwt.jar > /opt/scitokens-server/lib/jwt.jar ;\
    curl -L -s https://github.com/ncsa/oa4mp/releases/download/mutable/clc.jar > /opt/scitokens-server/lib/scitokens-cli.jar ;\
    ...
    curl -L -s https://github.com/ncsa/oa4mp/releases/download/mutable/qdl-installer.jar >/tmp/oa2-qdl-installer.jar ;\
