...
RUN curl -s -L https://github.com/ncsa/OA4MP/releases/download/5.2.7.1/oauth2.war > /opt/tomcat/webapps/scitokens-server.war ;\
...
RUN curl -s -L https://github.com/ncsa/OA4MP/releases/download/5.2.7.1/jwt.jar > /opt/scitokens-server/lib/jwt.jar ;\
...
RUN curl -L -s https://github.com/ncsa/OA4MP/releases/download/5.2.7.1/oa2-cli.jar >/opt/scitokens-server/lib/scitokens-cli.jar ;\
...
RUN curl -L -s https://github.com/ncsa/OA4MP/releases/download/5.2.7.1/oa2-qdl-installer.jar >/tmp/oa2-qdl-installer.jar ;\
